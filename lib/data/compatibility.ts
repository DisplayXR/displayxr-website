...
export const runtimeCompositors: RuntimeCompositor[] = [
  ...
  { platform: "Linux", graphicsApi: "Vulkan", status: "beta", notes: "Preview — native Vulkan compositor over an X11/XCB or Wayland surface, xlib and wayland surface bindings, client-side title bar and phase-locked window drag on native Wayland, transparent overlays with live desktop content composited under the weave. Supported on Ubuntu 22.04/24.04/26.04 (hardware-validated on 24.04 and 26.04; X11 session recommended on 22.04); ships as .deb packages plus a one-command bundle tarball, not yet GA" },
];
